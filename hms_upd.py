...
def create_login_box():
    ...
    login_admin_button = tk.Button(login_box, text="Login as Admin", command=lambda: admin_login(email_entry.get(), password_entry.get()))
...
def admin_login(email, password):
    ...
    admin_credentials = {
        "dra.dalusung@example.com": "admin01",
        "dra.festejo@example.com": "admin02",
        "dra.isip@example.com": "admin03",
        "dr.sutare@example.com": "admin04"
    }
