...
def create_search_window():
    ...
    search_window.geometry("1210x490")
    ...
    search_results_tree.grid(row=4, column=0, columnspan=2, padx=10, pady=6)
...
background_image = Image.open("D:\DELL E7450\Desktop\Final Project\HMNAS-main\HMNAS-main\homepage.png")
...
# Display homepage content in the main window
